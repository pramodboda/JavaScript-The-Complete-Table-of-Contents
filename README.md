...
**Strong** PART 1: Basic and Intermediate JavaScript

**Strong** PART 2: Advanced JavaScript

**Strong** PART 3: Modern JavaScript

**Strong** PART 4: Data Structures and Algorithms(DS Algo/DSA)
